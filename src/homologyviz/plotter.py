...
# TODO: check all the function getting and returning Figure. In reallity, they are getting
...
def change_homoloy_color_traces(
    ...
    __________
    figure : dict
        Dictionary representing a Plotly figure obtained using Dash "State".
    """
    # Get new colorscale
